        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="text-gray-400 mr-[5%] text-xl place-self-center mb-16 drop-shadow-2xl w-[80%] md:w-[90%]">
            ...
            <p className=" indent-8">
              ...
              programming, or other means. I channel this passion into font-end
              development and game development. I am a detail-oriented
              programmer, with several collaborative experiences and a writing
              well-structured code and visually appealing user interfaces.
            </p>

            <h1 className=" text-2xl text-white mt-8">What's the goal?</h1>
            <p className=" indent-8">
              At first, my primary interest lay solely in game development.
              However, I have since shifted my focus to web development with the
              goal of becoming a full-stack developer. My main motivation is to
              gain a deeper understanding of the industry through firsthand
              experience and to comprehend the intricacies of software
              production within larger teams.
            </p>
            ...
            <p className=" indent-8">
              Outside of programming, I love to create digital art and paint. I
              also have a deep love for music, and am actually in an acapella
              called "Vermillion Vocalists"! Lastly, I love collecting/trading
              plant species.
            </p>
            <Link
              activeClass="active"
            ...
            >
              ...
              <li className=" w-auto mt-5 center inline-block list-none  text-center py-2 px-4 text-white bg-rose-600/80 rounded-md m-auto hover:bg-white hover:text-rose-600 duration-300">
                To my contact page
              </li>
            </Link>
          </div>
