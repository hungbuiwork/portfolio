  ...
  return (
    <div className="w-full pb-8">
      ...
      <div className="flex justify-center place-items-center">
        <div className="flex justify-center place-items-center rounded-xl  h-[60vw] md:h-[45vw]">
          <div
            onClick={() => changeIndex(-1)}
            className="w-[30%] hover:w-[45%] hover:cursor-pointer duration-300 relative left-6 rounded-xl overflow-hidden carousel-side"
          >
          ...
          <div
            onClick={() => changeIndex(1)}
            className="w-[30%] hover:w-[45%] hover:cursor-pointer duration-300 relative right-6 rounded-xl overflow-hidden carousel-side"
          >
            <Artwork art={art[trueIndex(index + 1)]}></Artwork>
          </div>
        </div>
