      ...
      <div className="flex flex-col md:flex-row justify-between">
        ...
        <div className=" shrink-1 text-center md:text-left flex flex-col justify-evenly mx-8 place-self-center">
          <div>
            ...
            {project.company && <h2 className=" text-white/90 text-lg">at <span className=" italic ">{project.company}</span></h2>}
            <div className={"flex flex-wrap place-content-center md:place-content-start"}>
          ...
          <p className=" text-gray-300 text-left indent-8 mt-6">{project.desc}</p>
